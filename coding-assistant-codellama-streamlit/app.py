...
# app config
st.set_page_config(page_title="✨E Cell DTC Code Generator - CodyBot✨", page_icon="✨🤖✨")
st.title("🤖 CodyBot - Code Generator at E Cell-DTC, Your Coding Assistant! ✨")
st.markdown("© 2024 E Cell-DTC. All rights reserved.")
